...
//                                         <textarea
//                                             className="response-textarea" required
...
const Clientquestionnaire = () => {
    ...
    const [tradingAnswer, setTradingAnswer] = useState('');
    const [rentalAnswer, setRentalAnswer] = useState('');
    const [accountingAnswer, setAccountingAnswer] = useState('');
    const [accrualsAnswer, setAccrualsAnswer] = useState('');
    const [hireAnswer, setHireAnswer] = useState('');
    ...
    const [accrualsResponse, setAccrualsResponse] = useState('');
    const [hireResponse, setHireResponse] = useState('');
    ...
    const isStepComplete = (stepId) => {
        switch (stepId) {
            case 'trading':
                return tradingAnswer && tradingResponse.trim() && rentalAnswer && rentalResponse.trim();
            case 'accounting':
                return accountingAnswer && accountingResponse.trim();
            case 'accruals':
                return accrualsAnswer && accrualsResponse.trim();
            case 'hire':
                return hireAnswer && hireResponse.trim();
            case 'asset':
                return assetAnswer && assetResponse.trim();
            case 'income':
                return incomeAnswer && incomeResponse.trim();
            case 'vehicle':
                return vehicleAnswer && vehicleResponse.trim();
            default:
                return true;
        }
    };
    ...
    const getCompletedSteps = () => {
        const completed = ['all']; // 'all' is always completed
        const stepOrder = ['trading', 'accounting', 'accruals', 'hire', 'asset', 'income', 'vehicle'];
    ...
    const handleStepClick = (stepId) => {
        ...
        // Allow clicking on current step, previous completed steps, or the immediate next step
        if (completedSteps.includes(stepId) || stepId === currentPage || 
            (targetIndex === currentIndex + 1 && isStepComplete(currentPage))) {
            setCurrentPage(stepId);
        } else {
    ...
    const handleNext = () => {
        const currentStepComplete = isStepComplete(currentPage);
        
        if (!currentStepComplete) {
            alert('Please complete all fields in the current step before proceeding.');
            return;
        }
    ...
    const isNextDisabled = () => {
        const currentIndex = getCurrentStepIndex();
        const currentStepComplete = isStepComplete(currentPage);
        return currentIndex >= steps.length - 1 || !currentStepComplete;
    };

    // Update step status based on completion
                                ...
                                <div className="response-section">
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <textarea
                                            className="response-textarea"
                                            placeholder="Enter your response here..."
                                            value={tradingResponse}
                                            onChange={(e) => setTradingResponse(e.target.value)}
                                        ></textarea>
                                        <button
                                            className="view-answer-btn"
                                            onClick={() => setShowLastYearResponse(true)}
                            ...
                            <div className="question-container">
                                ...
                                <div className="response-section">
                                    ...
                                    <textarea
                                        className="response-textarea"
                                        placeholder="Enter your response here..."
                                        value={rentalResponse}
                                        onChange={(e) => setRentalResponse(e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="question-container">
                                ...
                                <div className="response-section">
                                    ...
                                    <textarea
                                        className="response-textarea"
                                        placeholder="Please provide details about any accounting information or questions you have."
                                        value={accountingResponse}
                                        onChange={(e) => setAccountingResponse(e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="question-container">
                                ...
                                <div className="response-section">
                                    ...
                                    <textarea
                                        className="response-textarea"
                                        placeholder="Please provide details about any accruals or prepayments."
                                        value={accrualsResponse}
                                        onChange={(e) => setAccrualsResponse(e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="question-container">
                                ...
                                <div className="response-section">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Please provide details on any hire purchase agreements."
                                        value={hireResponse}
                                        onChange={(e) => setHireResponse(e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="question-container">
                                ...
                                <div className="response-section">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Please provide details on any assets or investments."
                                        value={assetResponse}
                                        onChange={(e) => setAssetResponse(e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="question-container">
                                ...
                                <div className="response-section">
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) => setIncomeResponse(e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="question-container">
                                ...
                                <div className="response-section">
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) => setVehicleResponse(e.target.value)}
                                    />
                                </div>
                            </div>
                        </div>
