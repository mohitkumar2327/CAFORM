...
const Clientquestionnaire7 = () => {
  const steps = [
    ...
    { id: 'hire', number: '✓', label: 'Hire Purchase', status: 'completed' },
    { id: 'asset', number: '✓', label: 'Asset and Investments', status: 'completed' },
    { id: 'income', number: '✓', label: 'Other Income', status: 'completed' },
    { id: 'vehicle', number: '7', label: 'Vehicle Expenses', status: 'current' }
  ];
...
export default Clientquestionnaire7;