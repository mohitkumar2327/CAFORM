...
//         setShowAddNewUserModal(true); // Open the add new user modal
//         setIsDropdownOpen(false); // Close the profile dropdown
//     };

//     const handleCloseAddNewUserModal = () => {
//         setShowAddNewUserModal(false); // Close the add new user modal
//     };

//     const handleAddUser = (newUser) => {
//         // Handle adding new user (you can add API call here)
//         console.log('New user added:', newUser);
//         // You might want to refresh user list or update global state here
//     };
...
//                                 </li>
//                                 <li>
//                                     <button className="dropdown-item" onClick={handleAddNewUserClick}>
//                                         <span>Add New User</span>
//                                     </button>
//                                 </li>
//                                 <li>
...
//             {/* Render the AddNewUserModal component */}
//             {showAddNewUserModal && (
//                 <AddNewUserModal 
